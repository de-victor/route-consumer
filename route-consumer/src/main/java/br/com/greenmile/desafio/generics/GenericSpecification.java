package br.com.greenmile.desafio.generics;
...
public abstract class GenericSpecification<E> implements Specification<E> {
    ...
    public Predicate toPredicate(Root<E> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
        ...
        list.forEach(searchElement ->{
            if (searchElement.getOperation().equals(SearchOperation.GREATER_THAN)) {
                ...
                predicates.add(criteriaBuilder.equal(rootPath(root, searchElement), searchElement.getValue()));
            } 
